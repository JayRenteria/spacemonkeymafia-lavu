...
// TODO: numberGuest less than capacity
...
//	var_dump($reservations);
	...
	?>
		...
		<div class="group">
			...
			<input class="invisible-input" type="text" value="<?php echo $_POST['name']; ?>" name="name">
			<input class="invisible-input" type="text" value="<?php echo $_POST['email']; ?>" name="email"/>
			<input class="invisible-input" type="text" value="<?php echo $_POST['phone']; ?>" name="phone"/>
			<input class="invisible-input" type="text" value="<?php echo $_POST['date']; ?>" name="date">
			<input class="invisible-input" type="text" value="<?php echo $_POST['numberOfGuests'];?>" name="numberOfGuests"/>
		</div>
